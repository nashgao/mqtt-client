...
class ConnectionMetrics
{
    ...
    public function recordSuccessfulConnection(float $connectionTime = null): void
    {
    ...
    public function recordFailedConnection(): void
    {
    ...
    public function recordReconnection(): void
    {
        $this->reconnections++;
    }

    public function recordDisconnection(): void
    {
